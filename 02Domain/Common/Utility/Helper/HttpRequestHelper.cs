...
namespace JSHC.OrderingSystem.Common.Utility.Helper
{
    public class HttpRequestHelper
    {
        ...
        private static IOptionsMonitor<AppSettings> _configuration => IocManager.Resolve<IOptionsMonitor<AppSettings>> ();
        static HttpRequestHelper ()
        {
            var gateWayUrl = _configuration.CurrentValue.GateWayUrl;
        ...
        {
            var jshcAppId = _configuration.CurrentValue.JSHC_AppId;
            var jshcAppSecret = _configuration.CurrentValue.JSHC_AppSecret;
